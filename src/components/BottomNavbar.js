...
const BottomNavbar = () => {
    ...
    return (
        <div className="bottombar">
            <div className="sticky w-full bottom-0 z-10 bg-white  flex justify-between py-2" style={{ boxShadow: "0pt -3pt 6pt #00000029" }}>
                <Link href="/profile" className="flex flex-col items-center text-xs font-medium py-3 xs:px-4 px-3 text-[#78757E] flex-1">
                    ...
                    <span className="text-[11pt] font-medium pt-2">Yo</span>
                </Link>
                <Link href="#" className="flex flex-col items-center text-xs font-medium py-3 xs:px-4 px-3 text-black flex-1">
                    ...
                    <span className="text-[11pt] font-medium pt-2">Comunidad</span>
                </Link>

                {/* Centered Upload Button */}
                <button className="relative flex flex-col items-center flex-1">
                    <div className="absolute xs:bottom-7 bottom-10 left-1/2 transform -translate-x-1/2 xs:p-5 p-3 rounded-full bg-black shadow-lg">
                ...
                <Link href="#" className="flex flex-col items-center text-xs font-medium py-3 xs:px-4 px-3 text-[#78757E] flex-1">
                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 30 32.417">
                        <path id="Tokens_Icon" d="M130.167-867.917l-8.417-4.708L135-880l13.25,7.375-8.417,4.708a6.75,6.75,0,0,0-2.208-1.542A6.533,6.533,0,0,0,135-870a6.533,6.533,0,0,0-2.625.542A6.75,6.75,0,0,0,130.167-867.917Zm3.167,20.333L120-855v-14.792L128.542-865a4.448,4.448,0,0,0-.167.813,8.183,8.183,0,0,0-.042.854,6.529,6.529,0,0,0,1.375,4.083,6.487,6.487,0,0,0,3.625,2.375ZM135-860a3.21,3.21,0,0,1-2.354-.979,3.21,3.21,0,0,1-.979-2.354,3.21,3.21,0,0,1,.979-2.354,3.21,3.21,0,0,1,2.354-.979,3.21,3.21,0,0,1,2.354.979,3.21,3.21,0,0,1,.979,2.354,3.21,3.21,0,0,1-.979,2.354A3.21,3.21,0,0,1,135-860Zm1.667,12.417v-9.292a6.487,6.487,0,0,0,3.625-2.375,6.529,6.529,0,0,0,1.375-4.083,8.183,8.183,0,0,0-.042-.854,4.447,4.447,0,0,0-.167-.812L150-869.792V-855Z" transform="translate(-120 880)" fill="currentColor" opacity="0.7" />
                    </svg>
                    <span className="text-[11pt] font-medium pt-2">Tokens</span>
                </Link>
                <Link href="#" className="flex flex-col items-center text-xs font-medium py-3 xs:px-4 px-3 text-[#78757E] flex-1">
                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 30 26.667">
                    ...
                    <span className="text-[11pt] font-medium pt-2">Store</span>
                </Link>
            </div>
        </div>
    );
